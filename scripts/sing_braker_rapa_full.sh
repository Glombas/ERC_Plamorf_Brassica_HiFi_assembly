...
#cd /jic/scratch/groups/Richard-Morris/glombikm/brassica_rna_and_single_cell_data/X204SC22115099-Z01-F001/01.RawData/

#for f in HOMO*/*.gz; do mv $f all_homo_braker/; done
#gunzip all_homo_braker/*.gz

cd /jic/scratch/groups/Richard-Morris/glombikm/brassica_hifi_data/bamfiles/fastq/braker_annot/rapa_full/

singularity exec /hpc-home/glombik/braker3.sif braker.pl --species=Brassicarapa_FP_full_nolow --AUGUSTUS_ab_initio --gff3 --threads 20 --workingdir=wd_sing --genome=full_ragtag.scaffold.fasta.masked --rnaseq_sets_ids=HOMO_R1,HOMO_R2,HOMO_R3 --rnaseq_sets_dirs=/jic/scratch/groups/Richard-Morris/glombikm/brassica_rna_and_single_cell_data/X204SC22115099-Z01-F001/01.RawData/all_homo_braker/

...
hifiasm -o hifiasm/homcovBnapus_primary_assembly -t 30 --hom-cov 59 /jic/scratch/groups/Richard-Morris/glombikm/brassica_hifi_data/bamfiles/fastq/m84049_240319_214729_s1.hifi_reads.bc2016.fastq 2> ./hifiasm/homcovBnapus_primary_assembly.log
...
awk -f /jic/scratch/groups/Richard-Morris/glombikm/brassica_hifi_data/scripts/wrap-fasta-sequence.awk ./homcovBnapus_primary_assembly.bp.p_ctg.fa > ./homcovBnapus_primary_assembly.bp.p_ctg_wrapped.fa

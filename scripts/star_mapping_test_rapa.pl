...
my $refnapus='/jic/scratch/groups/Richard-Morris/glombikm/brassica_hifi_data/bamfiles/fastq/hifiasm/anchoring/anchored_bnapus_daae.fa';
my $refrapa='/jic/scratch/groups/Richard-Morris/glombikm/brassica_hifi_data/bamfiles/fastq/hifiasm/anchoring/rt_anchor_rapa_chiifu/ragtag.scaffold.fasta';
...
my $list_of_samples = '/jic/scratch/groups/Richard-Morris/glombikm/brassica_rna_and_single_cell_data/mapping_test/rapabulklist.txt';
...
SLURM
 ...
 my $tmp_file = "$output_dir/tmp/star.$sample";
  ...
  print SLURM "source package aeee87c4-1923-4732-aca2-f2aff23580cc\n";
	...
	print SLURM "STAR --runThreadN 8 --genomeDir $refdirrapa --readFilesCommand zcat --readFilesIn $read1 $read2 --outFileNamePrefix $output_dir/$sample --outSAMtype BAM SortedByCoordinate\n";

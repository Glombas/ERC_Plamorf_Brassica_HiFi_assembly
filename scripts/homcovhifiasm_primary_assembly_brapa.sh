...
hifiasm -o hifiasm/homcovBrapa_primary_assembly -t 30 --hom-cov 50 /jic/scratch/groups/Richard-Morris/glombikm/brassica_hifi_data/bamfiles/fastq/m84049_240319_214729_s1.hifi_reads.bc2005.fastq 2> ./hifiasm/homcovBrapa_primary_assembly.log

cd hifiasm/

## convert gfa to fa file
awk '/^S/{print ">"$2;print $3}' ./homcovBrapa_primary_assembly.bp.p_ctg.gfa > ./homcovBrapa_primary_assembly.bp.p_ctg.fa
...
awk -f /jic/scratch/groups/Richard-Morris/glombikm/brassica_hifi_data/scripts/wrap-fasta-sequence.awk ./homcovBrapa_primary_assembly.bp.p_ctg.fa > ./homcovBrapa_primary_assembly.bp.p_ctg_wrapped.fa
